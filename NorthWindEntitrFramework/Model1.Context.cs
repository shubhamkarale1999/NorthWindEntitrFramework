...
namespace NorthWindEntitrFramework
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<usp_EmployeeSalesReport_Result> usp_EmployeeSalesReport(Nullable<System.DateTime> fromdate_, Nullable<System.DateTime> todate_)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_EmployeeSalesReport_Result>("usp_EmployeeSalesReport", fromdate_Parameter, todate_Parameter);
        }
    
        public virtual ObjectResult<usp_SalesByMonth_Result> usp_SalesByMonth(string productName, string monthName, Nullable<int> year)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_SalesByMonth_Result>("usp_SalesByMonth", productNameParameter, monthNameParameter, yearParameter);
        }
    }
}
